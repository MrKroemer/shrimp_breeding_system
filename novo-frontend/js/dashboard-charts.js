...
function initCardCharts() {
    ...
    new Chart(document.getElementById('analises-chart'), {
        type: 'doughnut',
        data: {
    ...
    new Chart(document.getElementById('ciclos-chart'), {
        type: 'doughnut',
        data: {
    ...
    new Chart(document.getElementById('producao-chart'), {
        type: 'doughnut',
        data: {
    ...
    // Configuração para o gráfico de Taxa de Conclusão
    new Chart(document.getElementById('conclusao-chart'), {
        type: 'doughnut',
        data: {
