...
class AnalisesLaboratoriais extends Model
{
    const CREATED_AT = 'criado_em';
    const UPDATED_AT = 'alterado_em';

    protected $table = 'analises_laboratoriais';
    ...
    {
        return $this->hasMany(AnalisesBacteriologicas::class, 'analise_laboratorial_id', 'id');
    }

    public function calcicas()
    {
        return $this->hasMany(AnalisesCalcicas::class, 'analise_laboratorial_id', 'id');
    }
