...
use App\Http\Requests\MortalidadeChartCreateFormRequest;
...
class MortalidadeChartController extends Controller
{
    private $rowsPerPage = 10;

    public function createMortalidadeChart(int $listagem = 1)
    {
        ...
        return view('charts.mortalidade.create')
    ...
    public function generateMortalidadeChart(MortalidadeChartCreateFormRequest $request)
    {
        ...
        return view('charts.mortalidade.chart')
