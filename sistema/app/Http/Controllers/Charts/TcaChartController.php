...
use App\Http\Requests\TcaChartCreateFormRequest;
...
class TcaChartController extends Controller
{
    public function createTcaChart(int $listagem = 1)
    {
    ...
    public function generateTcaChart(TcaChartCreateFormRequest $request)
    {
