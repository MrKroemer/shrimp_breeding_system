...
class EnvioParaTemporariosReport extends mPDF
{
    ...
    public function __construct()
    {
        ...
        $this->documentTitle = 'Relatório de envio para estoques temporários';
    ...
    {
        $locais_transferencia = $params[0];
        $data_transferencia  = $params[1];
        ...
        $this->documentBody .= '<td colspan="2" style="border-bottom: 1px solid #000; font-size: 10px;"><i>Consumos realizados em <b>' . $data_transferencia . '</b></i></td>';
        $this->documentBody .= '</tr>';

        foreach ($locais_transferencia as $local => $produtos) {

            $this->documentBody .= '<tr>';
            $this->documentBody .= '<td colspan="2" style="border-bottom: 1px solid #000;">&nbsp;</td>';
            $this->documentBody .= '</tr>';
            $this->documentBody .= '<tr>';
            $this->documentBody .= '<td colspan="2" style="width: 100%; border-bottom: 1px solid #000; background-color: #e6e6e6;"><b>Enviar para: ' . $local . '</b></td>';
            $this->documentBody .= '</tr>';
            $this->documentBody .= '<tr>';
            $this->documentBody .= '<td style="width: 50%; border-bottom: 1px solid #000; background-color: #e6e6e6;"><b>Produto</b></td>';
            $this->documentBody .= '<td style="width: 50%; border-bottom: 1px solid #000; background-color: #e6e6e6;"><b>Quantidade</b></td>';
            $this->documentBody .= '</tr>';
            ...
            foreach ($produtos as $produto_id => $quantidade) {
                ...
                $this->documentBody .= '<tr>';
                $this->documentBody .= '<td style="border-bottom: 1px solid #000;">' . $produto->nome . '</td>';
                $this->documentBody .= '<td style="border-bottom: 1px solid #000;">' . DataPolisher::numberFormat($quantidade, 4) . ' ' . $produto->unidade_saida->sigla . '</td>';
                $this->documentBody .= '</tr>';
