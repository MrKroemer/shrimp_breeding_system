...
class ConsumoProdutosReport extends mPDF
{
    ...
    public function __construct()
    {
        ...
        $this->documentTitle = 'Relatório de consumo de produtos';
    ...
    {   
        ...
        foreach ($ciclos as $ciclo) {
            ...
            if ($estoque_saidas[$ciclo->id]->isNotEmpty()) {
                ...
                $this->documentBody .= '<tr>';
                $this->documentBody .= '<td colspan="5" style="border-bottom: 1px solid #000; border-top: 1px solid #000; background-color: #e6e6e6;"><b>TOTAIS:</b></td>';
                $this->documentBody .= '</tr>';
                ...
                $this->documentBody .= '<tr>';
                $this->documentBody .= '<td colspan="3" style="border-top: 1px solid #000; background-color: #e6e6e6;"><b>Custo estimado total:</b></td>';
                $this->documentBody .= '<td colspan="2" style="border-top: 1px solid #000; background-color: #e6e6e6;"><b>R$ ' . DataPolisher::numberFormat($custo_total) . '</b></td>';
                $this->documentBody .= '</tr>';
