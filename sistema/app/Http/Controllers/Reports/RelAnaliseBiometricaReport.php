...
class ResumoAnalisesBiometricasReport
{
    ...
    public function __construct()
    {
        ...
        $this->documentTitle  = 'Resumo das Análises Biométricas';
        //Definição o cabeçalho
        $this->documentHeader = ('
    ...
    ');
        ...
        $this->documentBody   = ('
            ...
            <tr>
               <td colspan="39" style="margin-left: 2px;border-bottom: 1px solid #000;text-align:left">Data da Solicitação: {{$data_solicitacao}}</td>
            </tr>
            <tr>
               <td colspan="6"  style="border-right: 1px solid #000;">Informações básicas</td>
               <td colspan="2"  style="border-right: 1px solid #000;">Dias</td>
               <td colspan="17" style="border-right: 1px solid #000;">Resumo das últimas biometrias</td>
               <td colspan="11">Estimativas</td>
            </tr>
            <tr>
                <td class="cabecalho">Viv.</td>
                <td class="cabecalho">Área</td>
                <td class="cabecalho" style="width:25px;">Pov.</td>
                <td class="cabecalho" style="width:7px;">Dens.</td>
                <td class="cabecalho" >Lote</td>
                <td class="cabecalho" style="width: 3.0%; border-right: 1px solid #000;">Gene.</td>
                <td class="cabecalho">Prep.</td>
                <td class="cabecalho" style="border-right: 1px solid #000;">Cult.</td>
                ...
                <td class="cabecalho" style="border-right: 1px solid #000;">17</td>
                <td class="cabecalho" style="width: 3.0%;">Cr. Sem.</td>
                <td class="cabecalho" style="width: 3.0%;">Cr. méd.</td>
                <td class="cabecalho" style="width: 3.0%;">Cr. 2US.</td>
                <td class="cabecalho" style="width: 3.0%;">Dens.</td>
                <td class="cabecalho" style="width: 3.0%;">Sob.</td>
                <td class="cabecalho" style="width: 5.0%;">Bio.</td>
                <td class="cabecalho" style="width: 4.0%;">Kg/ha</td>
                <td class="cabecalho" style="width: 3.0%;">T.C.A.</td
                <td class="cabecalho" style="width: 3.0%;">T.C.A.P</t
                <td class="cabecalho" style="width: 3.0%;">R$/Kg</td>
                <td class="cabecalho" style="width: 7.0%;">Custo Total</td>
                <td class="cabecalho">Viv.</td>
            </tr>
        
        '); // Defina o conteúdo do corpo do documento
    }

    public function generateReport(array $param)
    {   
        $ciclos = $param[0];
        $data_solicitacao = $param[1];
        $data_solicitacao = $data_solicitacao->format('Y-m-d');
        // Prepare o conteúdo HTML do relatório
        $html = '<html><head>';
        $html .= '<style>' . $this->documentCss . '</style>';
        $html .= '</head><body>';
        $html .= '<header>' . $this->documentHeader . '</header>';
        $html .= $this->documentBody;
        $html .= '<footer>' . $this->documentFooter . '</footer>';
        $html .= '</body></html>';

        $color_flag = 0;
        $color = array("#fff", "#e6e6e6");
