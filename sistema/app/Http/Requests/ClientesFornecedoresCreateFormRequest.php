...
class ClientesFornecedoresCreateFormRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'cnpj'       => 'required|digits_between:1,15|unique:clientes_fornecedores,cnpj',
            'ie'         => 'required|digits_between:1,15|unique:clientes_fornecedores,ie',
    ...
    public function messages()
    {
        return [
            ...
            'cnpj.unique'         => 'O "CNPJ" informado já está registrado no sistema.',

            'ie.required'         => 'O campo "I.E." deve ser informado.',
            'ie.digits_between'   => 'O campo "I.E." deve possuir entre :min e :max dígitos.',
            'ie.unique'           => 'O "I.E." informado já está registrado no sistema.',
