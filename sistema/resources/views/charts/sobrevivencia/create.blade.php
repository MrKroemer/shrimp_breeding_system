...
@section('title', 'Gráfico de sobrevivência')
...
<ol class="breadcrumb">
    ...
    <li><a href="">Gráficos de sobrevivência</a></li>
</ol>
@endsection
...
<div class="box">
    ...
    <div class="box-body">
        ...
        @endphp
        <form action="{{ route('admin.graficos_sobrevivencia.to_generate') }}" method="POST">
            {!! csrf_field() !!}
            ...
            <div class="form-group" id="ciclos_ativos" name="ciclos_ativos">
                <div class="box box-default box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ciclos Ativos <a style="font-size: 9px;" href="{{ route('admin.graficos_sobrevivencia.listagem', ['listagem' => 2]) }}">Listagem Completa<a/></h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
            ...
            @if($listagem > 1)
                <div class="form-group" id="ciclos_inativos" name="ciclos_inativos">
                    <div class="box box-default box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">Ciclos Inativos <a style="font-size: 9px;" href="{{ route('admin.graficos_sobrevivencia.listagem', ['listagem' => 1]) }}">Listagem Simples<a/></h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
