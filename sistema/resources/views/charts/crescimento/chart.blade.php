...
@php
    ...
    $maxAxisY = 0;
@endphp
@section('title', 'Gráfico de Crescimento Amostras')

@section('content_header')
<h1>Gráfico de Crescimento Amostras</h1>

<ol class="breadcrumb">
    <li><a href="">Dashboard</a></li>
    <li><a href="{{ route('admin.graficos_crescimento') }}">Gráfico de Crescimento</a></li>
</ol>
@endsection
