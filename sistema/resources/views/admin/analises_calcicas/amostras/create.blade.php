...
<div class="box">
    ...
    <div class="box-body">
        <form id="form_analise_calcica_amostra" action="{{ route('admin.analises_calcicas.amostras.to_store', ['analise_laboratorial_id' => $analise_laboratorial->id]) }}" method="POST" onchange="submitByAjax(this.id);">
        {!! csrf_field() !!}
                ...
                <tr>
                    <td>
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="dureza_{{ $tanque->id() }}">Dureza cálcica</label>
                            ...
                            <div class="col-md-2">
                                <label for="moleculas_{{ $tanque->id() }}">Cálcio</label>
                            ...
                            <div class="col-md-1">
                                ...
                                @if (isset($tanque->analise_calcica_id))
                                    <button type="button" onclick="onActionForRequest('{{ route('admin.analises_calcicas.amostras.to_remove', ['analise_laboratorial_id' => $analise_laboratorial->id, 'id' => $tanque->analise_calcica_id]) }}');" class="btn btn-danger btn-xs">
