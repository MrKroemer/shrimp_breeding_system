...
<h1>Listagem de análises cálcicas</h1>
...
<div class="box">
    <div class="box-header">
        <form action="{{ route('admin.analises_calcicas.to_search') }}" method="POST" class="form form-inline">
            {!! csrf_field() !!}
            ...
            <a href="{{ route('admin.analises_calcicas.to_create') }}" class="btn btn-success">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('admin.analises_calcicas.amostras.to_create', ['analise_laboratorial_id' => $analise_laboratorial->id]) }}"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i>Registro de amostras</a></li>
                                </ul>
                            </div>
                            @if ($analise_laboratorial->calcicas->count() == 0)
                                <a href="{{ route('admin.analises_calcicas.to_edit', ['id' => $analise_laboratorial->id]) }}" class="btn btn-primary btn-xs">
                                    <i class="fa fa-edit" aria-hidden="true"></i> Editar
                                </a>
                            @endif
                            <button type="button" onclick="onActionForRequest('{{ route('admin.analises_calcicas.to_remove', ['id' => $analise_laboratorial->id]) }}');" class="btn btn-danger btn-xs">
