...
<h1>Cadastro de produtos de saídas avulsas</h1>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        @endphp
        <form action="{{ route('admin.saidas_avulsas.produtos.to_store', ['saida_avulsa_id' => $saida_avulsa_id]) }}" method="POST">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <a href="{{ route('admin.saidas_avulsas.produtos', ['saida_avulsa_id' => $saida_avulsa_id]) }}" class="btn btn-success">
