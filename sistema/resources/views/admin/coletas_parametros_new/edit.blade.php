...
<h1>Edição de análises bacteriológicas</h1>
...
<div class="box">
    ...
    <div class="box-body">
        <form action="{{ route('admin.analises_bacteriologicas.to_update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <a href="{{ route('admin.analises_bacteriologicas') }}" class="btn btn-success">
