...
<h1>Edição de análises magnésicas</h1>

<ol class="breadcrumb">
    <li><a href="">Dashboard</a></li>
    <li><a href="">Análises magnesicas</a></li>
...
<div class="box">
    ...
    <div class="box-body">
        <form action="{{ route('admin.analises_magnesicas.to_update', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <a href="{{ route('admin.analises_magnesicas') }}" class="btn btn-success">
