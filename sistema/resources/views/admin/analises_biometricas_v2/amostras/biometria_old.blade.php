<table cellspacing="0" cellpading="0">
  ...
  @foreach($analises as $analise)
    ...
    <tr>
      ...
      <td style="border-color: 000000;border-style: solid;border-width: 1px 1px 0px 1px;vertical-align:middle;text-align:center;background-color:#FFBEF9">{{number_format($analise->pesomedio(), 1, '.', ',')}}</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="border-color: 000000;border-style: solid;border-width: 1px 1px 0px 1px;vertical-align:middle;text-align:center;background-color:#FFBEF9">{{number_format(($analise->desvio_padrao()/$analise->pesomedio())*100, 1, '.', ',')."%"}}</td>
    </tr>
    <tr>
        ...
        <td style="border-color: 000000;border-style: solid;border-width: 1px 1px 0px 1px;vertical-align:middle;text-align:center;background-color:#FFBEF9">{{$analise->gramaturas->count()}}</td>
      </tr>
  @endforeach
