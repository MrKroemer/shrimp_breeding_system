  ...
  <tbody>
    ...
    @foreach ($analises as $viveiro => $analise)
      ...
      <tr>
        ...
        @foreach ($analise as $amostra)
          @php
              $pesomedio = $amostra->peso_total/$amostra->total_amostras;
      ...
      <tr>
        ...
        @foreach ($analise as $amostra)
          ...
          <td align="center" bgcolor="{{$class}}">{{number_format(($amostra->desvio_padrao()/$amostra->pesomedio())*100, 1, '.', ',')."%"}}</td>
          @php
              if($class == "#FFB6C1"){
                $class = "#FFFFFF";
              }else{
      ...
      <tr>
        ...
        @foreach ($analise as $amostra)
        @php
            $classificacao = $amostra->classificacao();
