...
<div class="box">
    ...
    <div class="box-body">
        ...
        @endphp
        <form action="{{ route('admin.preparacoes_v2.aplicacoes.to_store', ['preparacao_id' => $preparacao->id]) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <a href="{{ route('admin.preparacoes_v2.aplicacoes', ['preparacao_id' => $preparacao->id]) }}" class="btn btn-success">
