...
<h1>Edição de períodos de utilização</h1>
...
<div class="box">
    ...
    <div class="box-body">
        <form action="{{ route('admin.receitas_laboratoriais.receitas_laboratoriais_periodos.to_update', ['receita_laboratorial_id' => $receita_laboratorial->id, 'id' => $id]) }}" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
