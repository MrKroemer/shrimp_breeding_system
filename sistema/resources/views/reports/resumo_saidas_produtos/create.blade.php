...
@section('title', 'Relatório de resumo de saídas de produtos')

@section('content_header')
<h1>Relatório de resumo de saídas de produtos</h1>

<ol class="breadcrumb">
    <li><a href="">Dashboard</a></li>
    <li><a href="">Relatório de resumo de saídas de produtos</a></li>
</ol>
@endsection
...
<div class="box">
    ...
    <div class="box-body">
        ...
        @endphp
        <form action="{{ route('admin.resumo_saidas_produtos.to_view') }}" method="POST" target="_blank">
            {!! csrf_field() !!}
