...
@section('title', 'Relatório de consumo por ciclos')

@section('content_header')
<h1>Relatório de consumo por ciclos</h1>

<ol class="breadcrumb">
    <li><a href="">Dashboard</a></li>
    <li><a href="">Relatório de consumo por ciclos</a></li>
</ol>
@endsection
...
<div class="box">
    ...
    <div class="box-body">
        ...
        @endphp
        <form action="{{ route('admin.consumos_por_ciclo.to_view') }}" method="POST" target="_blank">
            {!! csrf_field() !!}
